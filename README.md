...
## 기능 구현 정리
1. [x] 파일입출력으로 products.md에 적힌 현재 존재하는 물건들 띄우고 관리하는 기능
2. [] 프로모션에 대한 정보를 가져오고, 현재날짜와 비교하여 프로모션의 적용을 판단하는 기능
3. [] 구매할 상품을 입력받는 기능
4. [] 구매할 상품이 프로모션 적용상품인지 판단하는 기능
5. [] 구매할 상품의 재고가 모자르지 않는지 판단하는 기능
6. [] 구매한 것들에 대한 계산을 하는 기능
4. [] 영수증 발행하는 기능
